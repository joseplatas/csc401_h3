...
public class Initialize {	//This class does all of the pre-processing, like reading in the file, calculating edge weights, and populating the has map.
	...
	public HashMap Initialize() throws IOException{
		try {
			...
			/* The following while statements iterate through the RTF file.
			 * The "if input is empty" tests effectively separate the different sections of the RTF file;
			 * 		Section 1 is a single line telling us how many nodes and edges we have.
			 * 		Section 2 tells us the X and Y coordinate of each node
			 * 		Section 3 tells us which nodes are connected.
			 * 
			 * */
